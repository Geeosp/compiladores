...
public class LogicaTest extends RWTest {
  ...
  // @Ignore
  // @Test
  // public void testResolucaoFNC() throws IOException, WalaException,
  // CancelException, ParseException, InvalidClassFileException {
  //
  // String strCompUnit = srcdir + SEP + "logica" + SEP + "Resolucao.java";
  ...
  //
  // @Test
  // public void testResolucaoFNC2() throws IOException, WalaException,
  // CancelException, ParseException, InvalidClassFileException {
  //
  ...
  //
  // @Test
  // public void testFunctionsIsLiteral() throws IOException, WalaException,
  // CancelException, ParseException, InvalidClassFileException {
  //
  ...
  // @Test
  // public void testFunctionsEliminar() throws IOException, WalaException,
  // CancelException, ParseException, InvalidClassFileException {
  //
  // String strCompUnit = srcdir + SEP + "logica" + SEP + "Functions.java";
